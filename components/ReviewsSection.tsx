...
const fallbackReviews: Review[] = [
  ...
  },
  {
    ...
    plan: "Pro",
    rating: 4.5,
    text: "The weekly planner plus caption ideas are lifesavers. I can plan my schedule and export packs without bouncing between tools.",
    showAvatar: false,
    avatarUrl: null,
  ...
  },
  {
    ...
    plan: "Elite",
    rating: 5,
    text: "I like that it’s built for creator platforms—Content Ideas gives me subscriber-ready ideas without me rewriting everything.",
    showAvatar: false,
    avatarUrl: null,
  ...
  },
  {
    ...
    plan: "Elite",
    rating: 5,
    text: "The advanced creator tools are a game-changer for managing my premium content. The roleplay scenarios and messaging tools help me engage subscribers better.",
    showAvatar: false,
    avatarUrl: null,
  ...
  },
  {
    ...
    plan: "Elite",
    rating: 5,
    text: "The advanced creator features are incredible. The content calendar and fan management tools save me hours every week.",
    showAvatar: false,
    avatarUrl: null,
