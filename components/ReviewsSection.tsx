...
const fallbackReviews: Review[] = [
  ...
  },
  {
    ...
    plan: "Elite",
    rating: 5,
    text: "Monetized Creator Studio is a game-changer for managing my OnlyFans and Fansly content. The roleplay scenarios and messaging tools help me engage subscribers better.",
    showAvatar: false,
    avatarUrl: null,
  ...
  },
  {
    ...
    plan: "Elite",
    rating: 5,
    text: "The Monetized Creator Studio features are incredible. I use it for both OnlyFans and Fansly—the content calendar and fan management tools save me hours every week.",
    showAvatar: false,
    avatarUrl: null,
