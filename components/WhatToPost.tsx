              ...
              {selectedPlatform === 'mypage' && (
                <div className="p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                  <p className="text-sm text-indigo-700 dark:text-indigo-300">
                    <strong>My Page ideas</strong> are generated from your Fan Hub analytics—likes, comments, post revenue (unlocks and tips), and engagement patterns—to suggest content that resonates with fans and earns.
                  </p>
                </div>
              )}
