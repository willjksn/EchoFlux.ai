  ...
  const toggleAccountConnection = (platform: Platform) => {
    setSettings(prevSettings => ({
        ...
        connectedAccounts: {
            ...
            [platform]: !prevSettings.connectedAccounts[platform]
        }
    }));
  };
      ...
      case 1:
        return (
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Welcome to your new dashboard!</h2>
            <p className="mt-2 text-gray-500 dark:text-gray-400">Let's get you set up in just a couple of quick steps.</p>
          </div>
        );
      case 2:
        return (
          <div>
            <h2 className="text-2xl font-bold text-center text-gray-900 dark:text-white">Connect Your First Account</h2>
            <p className="mt-2 text-center text-gray-500 dark:text-gray-400">Select which accounts you'd like to manage with EngageSuite.ai. You can always change this later in Settings.</p>
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {(Object.keys(settings.connectedAccounts) as Platform[]).map(platform => (
                    <button key={platform} onClick={() => toggleAccountConnection(platform)} className={`flex items-center p-4 rounded-lg border-2 transition-colors ${settings.connectedAccounts[platform] ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/30' : 'border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
      ...
      case 3:
        return (
            <div className="text-center">
                ...
                <p className="mt-2 text-gray-500 dark:text-gray-400">Click below to start a quick tour of the app's key features.</p>
            </div>
        );
      default:
        return null;
