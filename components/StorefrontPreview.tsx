...
import { getSocialIconStyle, getStorefrontSocialLinksWithIcons, MemberHubSocialLinksButton } from "./StorefrontSocialLinksUI";
...
export const StorefrontPreview: React.FC<StorefrontPreviewProps> = ({
  ...
  const socialLinks = getStorefrontSocialLinksWithIcons(config.socialLinks, "landing");
