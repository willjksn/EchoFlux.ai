                ...
                <div className="space-y-4 prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>
                          ...
                          subscribe, tip, buy, and message there; you configure pricing, posts, and safety tools in EchoFlux.
                        </li>
                    </ul>

                    <p className="mt-6">
                      Our mission is to replace a fragmented stack with one studio (EchoFlux) and one fan link (witme.io) so you can
                      plan, publish, and monetize without juggling ten tools.
                    </p>
                </div>
            </div>
        </div>
