    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 text-gray-700 dark:text-gray-300">
            <div className="text-center">
                ...
                <h2 className="mt-4 text-3xl font-bold text-gray-900 dark:text-white">The Creator Studio for Modern Creators</h2>
                    <p className="mt-2 text-lg text-gray-500 dark:text-gray-400">From planning to execution, we built the ultimate command center for modern creators.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md">
                ...
                <div className="space-y-4 prose prose-lg dark:prose-invert max-w-none">
                    <p>EchoFlux.ai began with a simple goal: to help creators move faster with smart help. But speed alone isn’t enough—true growth requires planning, deep relationships, and seamless execution.</p>
                    <p>Today, EchoFlux.ai is a unified <strong>Creator Studio</strong> with a strategic <strong>Command Center</strong> that keeps your content, audience insights, and growth actions in one place.</p>
                    ...
                    <p className="mt-6">Our mission is to replace your fragmented stack of 10 different tools with one cohesive, all-in-one platform. We handle the busy work—from planning to scheduling—so you can focus on the big picture and grow your brand authentically.</p>
                </div>
            </div>
        </div>
    );
